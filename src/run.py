...
if __name__ == "__main__":
    ...
    print(
        f"API Base URL: {'https://sandbox-quickbooks.api.intuit.com/v3/company/' if args.env == 'sandbox' else 'https://quickbooks.api.intuit.com/v3/company/'}"
    )
    ...
    print(
        f"To change settings, restart with: python run.py --env [sandbox|production] --model [gemini-flash|gemini-pro]"
    )
    print("================================================================")
