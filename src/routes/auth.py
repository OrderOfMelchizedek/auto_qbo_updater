from flask import Blueprint, jsonify, redirect, session, request, current_app
import logging
...
def disconnect():
    ...
    try:
        ...
        qbo_keys = ['qbo_authenticated', 'qbo_company_id', 'qbo_access_token', 
                   'qbo_refresh_token', 'qbo_token_expires_at']
        for key in qbo_keys:
