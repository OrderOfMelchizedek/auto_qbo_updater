...
def get_donations():
    ...
    try:
        ...
        matched_count = sum(1 for d in donations if d.get('qbCustomerStatus') in 
    ...
    try:
        ...
        log_audit_event(
            ...
            details={
                ...
                'updated_fields': list(donation_data.keys())
            },
...
def update_session_donations():
    ...
    try:
        ...
        log_audit_event(
            ...
            user_id=session.get('session_id'),
            details={
                'donation_count': len(new_donations),
                'action': 'bulk_update'
            },
            request_ip=request.remote_addr
        )
        ...
        return jsonify({
            'success': True,
            'message': 'Session donations updated',
            'count': len(new_donations)
        })
