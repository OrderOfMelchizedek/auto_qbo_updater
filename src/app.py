...
# For production, disable rate limiting temporarily due to Redis SSL issues
# TODO: Fix Redis SSL configuration for Flask-Limiter
if os.getenv("DYNO"):
    # In production, use memory storage to avoid Redis SSL issues
    limiter = Limiter(
        app=app,
    ...
    # In development, use Redis if available
    limiter = Limiter(
        app=app,
        key_func=get_remote_address,
        default_limits=["200 per day", "50 per hour"],
