#!/usr/bin/env python3
"""
Test script to process the actual dummy files with enrichment and show final JSON.
"""
...
class MockQBOService:
    """Mock QBO service with test data."""
        ...
        self.customers_data = [
            {
                ...
                "PrimaryEmailAddr": {"Address": "j.collins@example.com"},
            ...
            },
            {
                ...
                "PrimaryEmailAddr": {"Address": "jlang@email.com"},
                "PrimaryPhone": {"FreeFormNumber": "(217) 555-0100"},
            },
            {
                "Id": "3",
                "SyncToken": "2",
    ...
    def find_customer(self, search_term):
        ...
        for customer in self.customers_data:
            if search_lower in customer["DisplayName"].lower():
                return customer
        return None
