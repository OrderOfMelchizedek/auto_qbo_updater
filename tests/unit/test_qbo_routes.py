...
class TestQBORoutes:
    ...
    def test_manual_match_customer_success(self, client, mock_qbo_service, sample_donation, sample_customer):
        ...
        with (
            patch("routes.qbo.get_qbo_service", return_value=mock_qbo_service),
    ...
    def test_update_qbo_customer_no_match(self, client, sample_donation):
        ...
        response = client.post("/qbo/customer/update/donation_123", json={}, content_type="application/json")
